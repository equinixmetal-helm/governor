...
| api.image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/metal-toolbox/governor-api","tag":"v0.13.3"}` | image for the governor-api |
...
| api.image.tag | string | `"v0.13.3"` | image tag version |
