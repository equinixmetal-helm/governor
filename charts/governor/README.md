...
| api.image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/metal-toolbox/governor-api","tag":"v0.13.1"}` | image for the governor-api |
...
| api.image.tag | string | `"v0.13.1"` | image tag version |
