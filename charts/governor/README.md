...
| api.image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/metal-toolbox/governor-api","tag":"v0.8.0"}` | image for the governor-api |
...
| api.image.tag | string | `"v0.8.0"` | image tag version |
