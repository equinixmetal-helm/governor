...
| api.image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/metal-toolbox/governor-api","tag":"v0.13.4"}` | image for the governor-api |
...
| api.image.tag | string | `"v0.13.4"` | image tag version |
...
| cedar | object | `{"bindings":[],"enabled":false,"image":{"pullPolicy":"IfNotPresent","repository":"permitio/cedar-agent","tag":"0.2.2"},"port":8180,"resources":{"limits":{"cpu":"200m","memory":"128Mi"},"requests":{"cpu":"50m","memory":"64Mi"}},"roles":[],"securityContext":{"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsNonRoot":true,"runAsUser":1000}}` | cedar-agent external authorization sidecar settings |
