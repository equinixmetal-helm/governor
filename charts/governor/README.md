...
| api.image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/metal-toolbox/governor-api","tag":"v0.9.1"}` | image for the governor-api |
...
| api.image.tag | string | `"v0.9.1"` | image tag version |
